        ...
        >
            <Container sx={{ position: "relative", zIndex: 2 }}>
                ...
                >
                    ...
                    >
                        Let’s Start a <span style={{ color: goldColor }}>Project</span> Together
                    </Typography>
                    <Typography
                        sx={{
                        ...
                        <Stack spacing={4}>
                            {contacts.map((item, i) => (
                                ...
                                >
                                    ...
                                    >
                                        <Iconify icon={item.icon} width={28} sx={{ color: goldColor }} />
                                    </Box>
                                    <Box>
                                        <Typography
                                            variant="caption"
                    ...
                    <Box flex="1.2">
                        <Card
                            sx={{
                                ...
                                overflow: "visible",
                                boxShadow: isDark
                                    ? `0 20px 40px ${goldColor}0D`
                                    : `0 20px 40px ${goldColor}08`,
                            ...
                            <Stack spacing={3}>
                                ...
                                <Button
                                    ...
                                    sx={{
                                        ...
                                        "&:hover": {
                                            bgcolor: "#8B6D40",
                                            boxShadow: `0 15px 30px ${goldColor}4D`,
                                        },
                                        transition: "all 0.3s ease",
                                    }}
                                >
            ...
            >
                <Alert
                    ...
                    sx={{
                        borderRadius: "12px",
                        fontWeight: 600,
                        bgcolor: status?.type === "success" ? goldColor : "#d32f2f",
                    }}
                >
                    {status?.msg}
                </Alert>
...
const StyledTextField = ({ isDark, ...props }: any) => (
    <TextField
        {...props}
        variant="filled"
        InputProps={{
        ...
        sx={{
            ...
            "& .MuiFilledInput-root.Mui-focused": {
                ...
                boxShadow: `0 0 0 4px ${goldColor}1A`,
            },
        }}
    />
);